...
data = PlyData.read('/home/zhongyuj/dreamgaussian/logs/outputs_model.ply')


# Generate random 3D points as an example

x = data['vertex']['x']
y = data['vertex']['y']
z = data['vertex']['z']
# data1 = np.load('/home/zhongyuj/dreamgaussian/temp_ZJU_temp/scales_3.npz')['vertex']
# x = data1[...,0]
# y = data1[:,1]
# z = data1[:,2]
...
scatter = ax.scatter(x, y, -z, c='b', marker='o',s=0.001)
...
# Function to update the view when dragging or zooming
def update_view(e):
    ax.view_init(elev=ax.elev, azim=ax.azim)

# Connect the update_view function to mouse events
