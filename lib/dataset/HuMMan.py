...
class HuMManDatasetBatch(Dataset):
    def __init__(self, data_root=None, split='train', multi_person=True, num_instance=317, poses_start=0, poses_interval=6, poses_num=10, image_scaling=1/3, white_back=False, sample_obs_view=True, fix_obs_view=False, resolution=None):
